C  THIS VERSION: 14/02/1994 AT 02:52:34 PM., MODIFIED by SED for NLPAPI
      INTEGER FUNCTION MAINL()
C
...
C
      ...
      CHARACTER * 64   PRBDAT, PRBSOL, ONELIN, PRBSAV, ALIVED
...
CIBM  PARAMETER ( IINPB = 59, IOUTPB = 59,              IALIVE = 60 )
      PARAMETER ( INPUT = 55, IINRUN = 56, IOUTSL = 57, IOUT1L = 58 )
      PARAMETER ( IINPB = 59, IOUTPB =     IINPB      , IALIVE = 60 )
...
C
      OPEN( IINRUN, FILE = 'SPEC.SPC', FORM = 'FORMATTED',
     *      STATUS = 'UNKNOWN'  )
C
...
C
     ...
     *      STATUS = 'OLD'  )
      REWIND INPUT
      OPEN( IOUTSL, FILE = PRBSOL, FORM = 'FORMATTED',
     *      STATUS = 'UNKNOWN'  )
      REWIND IOUTSL
      OPEN( IOUT1L, FILE = ONELIN, FORM = 'FORMATTED',
     *      STATUS = 'UNKNOWN'  )
      OPEN( IINPB , FILE = PRBSAV, FORM = 'FORMATTED',
     *      STATUS = 'UNKNOWN'  )
      REWIND IINPB
C
...
CS    CALL SWRKSP( INPUT , IOUT  , IINRUN, IOUTSL, IOUT1L, IINPB ,
      CALL DWRKSP( INPUT , IOUT  , IINRUN, IOUTSL, IOUT1L, IINPB ,
