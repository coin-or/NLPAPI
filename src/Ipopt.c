...
F77DOUBLEPRECISION F77_FUNC(ipopt,IPOPT)(F77INTEGER*,F77DOUBLEPRECISION*,F77INTEGER*,F77INTEGER*,F77INTEGER*,F77DOUBLEPRECISION*,F77INTEGER*,F77INTEGER*,F77DOUBLEPRECISION*,F77DOUBLEPRECISION*,F77DOUBLEPRECISION*,F77DOUBLEPRECISION*,F77INTEGER*,F77DOUBLEPRECISION*,F77INTEGER*,F77INTEGER*,F77INTEGER*,F77INTEGER*,F77DOUBLEPRECISION*,F77INTEGER*,F77INTEGER*,F77DOUBLEPRECISION*,char*,int);
void F77_FUNC(eval_f,EVAL_F)(F77INTEGER*,F77DOUBLEPRECISION*,F77DOUBLEPRECISION*);
void F77_FUNC(eval_g,EVAL_G)(F77INTEGER*,F77DOUBLEPRECISION*,F77DOUBLEPRECISION*);
void F77_FUNC(eval_c,EVAL_C)(F77INTEGER*,F77DOUBLEPRECISION*,F77INTEGER*,F77DOUBLEPRECISION*);
void F77_FUNC(eval_a,EVAL_A)(F77INTEGER*,F77INTEGER*,F77DOUBLEPRECISION*,F77INTEGER*,F77DOUBLEPRECISION*,F77INTEGER*,F77INTEGER*);
void F77_FUNC(eval_h,EVAL_H)(F77INTEGER*,F77INTEGER*,F77DOUBLEPRECISION*,F77INTEGER*,F77DOUBLEPRECISION*,F77INTEGER*,F77DOUBLEPRECISION*,F77INTEGER*,F77INTEGER*);
...
int IPMinimize(NLIpopt this,NLProblem P,double *x0,double *z0,double *l0,double *x)
{
  ...
  F77DOUBLEPRECISION *pBNDS_L,*pBNDS_U,*pX,*pV_L,*pV_U,*pLAM;
  ...
  F77_FUNC(ipopt,IPOPT)(&N,pX,&M,&NLB,pILB,pBNDS_L,&NUB,pIUB,pBNDS_U,
			pV_L,pV_U,pLAM,&zero,NULL,&zero,NULL,&ITER,&IERR,
...
void F77_FUNC(eval_f,EVAL_F)(F77INTEGER *N, F77DOUBLEPRECISION *X, F77DOUBLEPRECISION *F)
{
  NLVector lnx;
  int verbose=0;
  int izero=0;
...
void F77_FUNC(eval_g,EVAL_G)(F77INTEGER *N, F77DOUBLEPRECISION *X, F77DOUBLEPRECISION *G)
{
  NLVector lnx,lng;
  int verbose=0;
...
void F77_FUNC(eval_c,EVAL_C)(F77INTEGER *N, F77DOUBLEPRECISION *X, F77INTEGER *M, F77DOUBLEPRECISION *C)
{
  int i;
  NLVector lnx;
  int izero=0;
...
void F77_FUNC(eval_a,EVAL_A)(F77INTEGER *TASK, F77INTEGER *N,
...
void F77_FUNC(eval_h,EVAL_H)(F77INTEGER *TASK, F77INTEGER *N,
