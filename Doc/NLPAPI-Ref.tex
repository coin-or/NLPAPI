...
\noindent
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Problem (argument 1) is NULL"}&4\\
\parbox[t]{5.in}{"Inequality Constraint \%d has \%d groups, only one is allowed currently and it must be the trivial group function"}&4\\
\parbox[t]{5.in}{"Inequality Constraint \%d group must currently have the trivial group function"}&4\\
...
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Problem (argument 1) is NULL"}&4\\
\parbox[t]{5.in}{"Equality Constraint \%d has \%d groups. This is not supported yet."}&12\\
\parbox[t]{5.in}{"Equality Constraint \%d has a nontrivial group function. This is not supported yet."}&12\\
...
\noindent
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Problem (first arg.) is NULL, you must supply a problem."}&12\\
\parbox[t]{5.in}{"name (second arg.) is NULL, you must supply a name for the constraint."}&12\\
\parbox[t]{5.in}{"This problem already has an objective."}&12\\
\parbox[t]{5.in}{"Out of memory, trying to allocate \%d bytes"}&12\\
\end{tabular}
\newpage
...
\noindent
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Problem (first arg.) is NULL."}&12\\
\parbox[t]{5.in}{"x (second arg.) is NULL."}&12\\
\end{tabular}
1newpage
...
\parbox[t]{5.in}{"Problem (first arg.) is NULL."}&12\\
\parbox[t]{5.in}{"x (second arg.) is NULL."}&12\\
\parbox[t]{5.in}{"g (third arg.) is NULL."}&12\\
\end{tabular}
\newpage
...
\parbox[t]{5.in}{"Problem (first arg.) is NULL."}&12\\
\parbox[t]{5.in}{"x (second arg.) is NULL."}&12\\
\parbox[t]{5.in}{"H (third arg.) is NULL."}&12\\
\end{tabular}
\newpage
...
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Problem (first arg.) is NULL."}&12\\
\parbox[t]{5.in}{"Constraint \%d (argument 2) is Invalid, must be in [0,\%d)."}&12\\
\parbox[t]{5.in}{"x (second arg.) is NULL."}&12\\
\parbox[t]{5.in}{"g (third arg.) is NULL."}&12\\
\end{tabular}
\newpage
...
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"File pointer (argument 1) is NULL"}&12\\
\parbox[t]{5.in}{"Vector (argument 2) is NULL"}&12\\
\end{tabular}
\newpage
...
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Pointer to Vector (argument 1) is NULL"}&4\\
\parbox[t]{5.in}{"Pointer to Vector (argument 2) is NULL"}&4\\
\end{tabular}
\newpage
...
\noindent
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"left vector (argument 1) is NULL"}&12\\
\parbox[t]{5.in}{"Matrix (argument 2) is NULL"}&12\\
\parbox[t]{5.in}{"right vector (argument 1) is NULL"}&12\\
\parbox[t]{5.in}{"Cannot find $u^TAv$ for a \%d vector a \%dx\%d matrix and a \%d vector."}&12\\
\end{tabular}
\newpage
...
\noindent
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"A (first argument) is NULL"}&12\\
\parbox[t]{5.in}{"x (second argument) is NULL"}&12\\
\parbox[t]{5.in}{"b (third argument) is NULL"}&12\\
\end{tabular}
\newpage
...
\noindent
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Matrix (first argument), is NULL"}&12\\
\parbox[t]{5.in}{"Address for the lower bound (third argument), is NULL"}&12\\
\parbox[t]{5.in}{"Address for the upper bound (fourth argument), is NULL"}&12\\
\end{tabular}
\newpage
...
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Matrix (first argument), is NULL"}&12\\
\parbox[t]{5.in}{"Array of row indices (fourth argument), is NULL"}&12\\
\parbox[t]{5.in}{"Array of submatrix elements (fifth argument), is NULL"}&12\\
\end{tabular}
\newpage
...
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Matrix (first argument), is NULL"}&12\\
\parbox[t]{5.in}{"Vector (third argument), is NULL"}&12\\
\end{tabular}
\newpage
...
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Matrix (first argument), is NULL"}&12\\
\parbox[t]{5.in}{"Matrix (second argument), is NULL"}&12\\
\parbox[t]{5.in}{"Result (third argument), is NULL"}&12\\
\end{tabular}
\newpage
...
\noindent
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Problem (first argument), is NULL"}&12\\
\parbox[t]{5.in}{"type \%c (second argument), is not valid. Must be 'O', 'I', 'E', or 'M'"}&12\\
\parbox[t]{5.in}{"Hessian (fourth argument), is NULL."}&12\\
\end{tabular}
\newpage
\leftline{\bf NLMData}
...
\hline
\parbox[t]{5.in}{"Problem (argument 1) is NULL"}&12\\
\parbox[t]{5.in}{"type (argument 2) is NULL"}&12\\
\parbox[t]{5.in}{"var (argument 3) is NULL"}&12\\
\parbox[t]{5.in}{"expr (argument 4) is NULL"}&12\\
\parbox[t]{5.in}{"Out of memory, trying to allocate \%d bytes"}&12\\
\end{tabular}
\newpage
...
\parbox[t]{5.in}{"Problem (argument 1) is NULL"}&12\\
\parbox[t]{5.in}{"type (argument 2) is NULL"}&12\\
\parbox[t]{5.in}{"vars (argument 5) is NULL"}&12\\
\parbox[t]{5.in}{"expr (argument 6) is NULL"}&12\\
\parbox[t]{5.in}{"Out of memory, trying to allocate \%d bytes"}&12\\
...
\noindent
\begin{tabular}{lc}Message&Severity\\\hline
\parbox[t]{5.in}{"Pointer to Lancelot (argument 1) is NULL"}&4\\
\end{tabular}
\newpage
